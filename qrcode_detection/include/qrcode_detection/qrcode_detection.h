...
#include <amrl_qrcode_detection/SetEnabled.h>
...
private:
    ...
    bool setEnableSrvCallback(amrl_qrcode_detection::SetEnabled::Request &req, amrl_qrcode_detection::SetEnabled::Response &res);
